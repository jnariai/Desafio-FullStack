...
it('create desenvolvedor', function () {
    ...
    expect($desenvolvedor->nivel_id)->toBe($this->storePayload['nivel_id'])
        ...
        ->and(CarbonImmutable::createFromFormat('d/m/Y', $response->json('data.data_nascimento'))->format('Y-m-d'))->toBe($this->storePayload['data_nascimento'])
...
it('update desenvolvedor', function () {
    ...
    expect($desenvolvedor->nivel_id)->toBe($this->updatePayload['nivel_id'])
        ...
        ->and(CarbonImmutable::createFromFormat('d/m/Y', $response->json('data.data_nascimento'))->format('Y-m-d'))->toBe($this->updatePayload['data_nascimento'])
